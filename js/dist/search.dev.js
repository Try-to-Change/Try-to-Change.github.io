...
/*exported searchFunc*/
var searchFunc = function searchFunc(path, searchId, contentId) {
  ...
  $.ajax({
    ...
    success: function success(xmlResponse) {
      ...
      $input.addEventListener("input", function () {
        var resultList = [];
        var keywords = getAllCombinations(this.value.trim().toLowerCase().split(" ")).sort(function (a, b) {
        ...
        datas.forEach(function (data) {
          ...
          var indexTitle = -1;
          var indexContent = -1;
          var firstOccur = -1; // only match artiles with not empty contents
